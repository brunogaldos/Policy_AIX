...
export class PolicySynthApiApp {
    ...
    constructor(controllers, port = undefined) {
        ...
        this.ws.on("connection", (ws) => {
            ...
            console.log(`📊 Current connected clients: ${Array.from(this.wsClients.keys()).join(", ")}`);
            console.log(`🔌 wsClients Map size: ${this.wsClients.size}`);

            const clientIdMessage = JSON.stringify({ clientId });
            console.log(`📤 Sending clientId to client: ${clientIdMessage}`);
            ...
            ws.on("close", () => {
                ...
                console.log(`📊 Remaining connected clients: ${Array.from(this.wsClients.keys()).join(", ")}`);
                console.log(`🔌 wsClients Map size: ${this.wsClients.size}`);
            });
            ws.on("error", () => {
                this.wsClients.delete(clientId);
