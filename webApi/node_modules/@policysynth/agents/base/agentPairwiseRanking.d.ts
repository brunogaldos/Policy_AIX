...
export declare abstract class PairwiseRankingAgent extends PolicySynthAgent {
    ...
    setupRankingPrompts(subProblemIndex: number, allItems: PsEloRateable[] | string[], maxPrompts?: number | undefined, updateFunction?: Function | undefined, maxParallellRanking?: number, disableStatusUpdates?: boolean): void;
    /**
