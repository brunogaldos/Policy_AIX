...
export class PolicySynthStandaloneAgent extends PolicySynthAgentBase {
    ...
    constructor(memory = {}) {
        ...
        this.modelManager.saveTokenUsage = async (prices, modelType, modelSize, tokensIn, cachedInTokens, tokensOut) => {
            this.logger.info(`(Standalone) Token usage for model ${modelType} (${modelSize}): tokensIn=${tokensIn}, tokensOut=${tokensOut}`);
        };
    }
    /**
