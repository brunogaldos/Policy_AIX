...
export class BaseChatModel extends PolicySynthAgentBase {
    ...
    config;
    dbModelId;
    constructor(config, modelName, maxTokensOut = 4096) {
        super();
    ...
    prettyPrintPromptMessages(messages) {
        return messages
            .map((msg, index) => {
            // 1) Truncate
            const truncatedContent = this.truncateXmlTags(msg.content, process.env.PS_DEBUG_PROMPT_MESSAGES_MAX_TAG_CHARS
