...
export class ClaudeChat extends BaseChatModel {
    ...
    async generate(messages, streaming, streamingCallback, media, tools, toolChoice = "auto", allowedTools) {
        ...
        if (systemMessage) {
            ...
            if (process.env.PS_PROMPT_DEBUG) {
                this.logger.debug(`--------------> Using system message with cache control: ${JSON.stringify(requestOptions.system, null, 2)}`);
            }
        }
        if (streaming) {
