...
export class PsConnectorFactory extends PolicySynthAgentBase {
    static createConnector(connector, connectorClass, agent, memory) {
        switch (connectorClass.configuration.classType) {
            ...
            case PsConnectorClassTypes.SubAgents:
                return this.createSubAgentsConnector(connector, connectorClass, agent, memory);
            default:
                this.logger.warn(`Unsupported connector type: ${connectorClass.configuration.classType}`);
                return null;
        }
    }
    static createDocumentConnector(connector, connectorClass, agent, memory) {
        switch (connectorClass.configuration.name) {
            ...
            default:
                this.logger.warn(`Unsupported document connector: ${connectorClass.configuration.name}`);
                return null;
        }
    }
    ...
    static createNotificationsConnector(connector, connectorClass, agent, memory) {
        switch (connectorClass.configuration.name) {
            ...
            default:
                this.logger.warn(`Unsupported notifications connector: ${connectorClass.configuration.name}`);
                return null;
        }
    }
    static createIdeasCollaborationConnector(connector, connectorClass, agent, memory) {
        switch (connectorClass.configuration.name) {
            ...
            default:
                this.logger.warn(`Unsupported collaboration connector: ${connectorClass.configuration.name}`);
                return null;
        }
    }
    ...
    static createSubAgentsConnector(connector, connectorClass, agent, memory) {
        return new PsSubAgentsConnector(connector, connectorClass, agent, memory);
    }
