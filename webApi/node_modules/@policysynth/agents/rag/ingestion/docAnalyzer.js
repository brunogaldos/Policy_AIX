...
`);
    async analyze(fileId, data, filesMetaData = {}) {
        ...
        for (let i = 0; i < dataChunks.length; i++) {
            ...
            this.logger.info(`Chunk ${i + 1} results: ${JSON.stringify(documentAnalysis, null, 2)}`);
        ...
        this.logger.info(`Review analysis results: ${JSON.stringify(refinedMetadata, null, 2)}`);
        ...
        this.logger.info(`Final refined analysis results: ${JSON.stringify(debugResults, null, 2)}`);
