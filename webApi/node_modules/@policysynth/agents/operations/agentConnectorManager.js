...
export class AgentConnectorManager extends PolicySynthAgentBase {
    async createConnector(agentId, connectorClassId, userId, name, type) {
        ...
        try {
            ...
            this.logger.info(`Creating connector for agent ${agentClass.id} version ${agentClass.version} ${JSON.stringify(agentClass.configuration, null, 2)}`);
            ...
            if (agentClass &&
                ...
                this.logger.info("connectorClass.class_base_id", connectorClass.class_base_id);
                this.logger.info("PsYourPrioritiesConnector.YOUR_PRIORITIES_CONNECTOR_CLASS_BASE_ID", PsYourPrioritiesConnector.YOUR_PRIORITIES_CONNECTOR_CLASS_BASE_ID);
                this.logger.info("process.env.PS_TEMP_AGENTS_FABRIC_GROUP_API_KEY", process.env.PS_TEMP_AGENTS_FABRIC_GROUP_API_KEY);
                this.logger.info("agentClass.configuration.defaultStructuredQuestions", agentClass.configuration.defaultStructuredQuestions);
