...
let YpGroup = class YpGroup extends YpCollection {
    ...
    _newPost() {
        ...
        if (!window.appUser.loggedIn()) {
            window.appUser.loginForNewPost(this.collectionId, this.collection?.configuration);
        }
        else {
    ...
    renderPostList(statusFilter) {
        return this.collection
          ...
          <div
            ...
            ?hidden="${!YpAccessHelpers.checkGroupAccess(this.collection) || !window.location.href.includes("agentBundle")}"
          >
