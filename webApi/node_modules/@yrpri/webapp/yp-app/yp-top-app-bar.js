...
let YpTopAppBar = class YpTopAppBar extends YpBaseElement {
    ...
    constructor() {
        ...
        this._boundOnDomainChanged = this._onDomainChanged.bind(this);
        this._boundOnMyDomainsLoaded = this._onMyDomainsLoaded.bind(this);
        this.lastScrollY = 0;
    }
    ...
    connectedCallback() {
        ...
        this.addGlobalListener("yp-domain-changed", this._boundOnDomainChanged);
        this.addGlobalListener("yp-my-domains-loaded", this._boundOnMyDomainsLoaded);
    }
    disconnectedCallback() {
        window.removeEventListener("scroll", this._boundHandleScroll);
        this.removeGlobalListener("yp-domain-changed", this._boundOnDomainChanged);
        this.removeGlobalListener("yp-my-domains-loaded", this._boundOnMyDomainsLoaded);
    ...
    render() {
        ...
        if (breadcrumbsWithTitle.length > 0 &&
...
__decorate([
    property({ type: Boolean })
], YpTopAppBar.prototype, "disableDomainDropdown", void 0);
__decorate([
    property({ type: Boolean })
