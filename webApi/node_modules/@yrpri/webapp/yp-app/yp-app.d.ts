...
export declare class YpApp extends YpBaseElement {
    ...
    private _boundUpdateLocation;
    private _boundAutoTranslateEvent;
    private _boundOnChangeHeader;
    private _boundOnUserChanged;
    private _boundNetWorkError;
    private _boundYpError;
    private _boundOpenToast;
    private _boundLanguageLoaded;
    private _boundRefreshDomain;
    private _boundRefreshCommunity;
    private _boundRefreshGroup;
    private _boundCloseNavDrawer;
    private _boundAppDialogsReady;
    constructor();
