...
export class YpThemeManager {
    ...
    async importFonts(fontImportsString) {
        ...
        const fontImports = Array.from(new Set(this.sanitizeFontImports(fontImportsString.split('\n'))));
        ...
        fontImports.forEach(url => {
            ...
            loadPromises.push(new Promise((resolve, reject) => {
                ...
                link.addEventListener('error', () => reject(new Error(`Failed to load font stylesheet: ${url}`)));
            }));
    ...
    themeChanged(target = undefined) {
        ...
        if (isDark) {
            if (this.bodyBackgroundColorDark) {
                document.body.style.backgroundColor = this.getHexColor(this.bodyBackgroundColorDark);
            }
            else {
            ...
            if (this.bodyBackgroundColorLight) {
                document.body.style.backgroundColor = this.getHexColor(this.bodyBackgroundColorLight);
            }
            else {
                document.body.style.backgroundColor = "";
            }
    ...
    applyBackgroundOverride(themeCss, color) {
