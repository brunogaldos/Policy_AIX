...
export class YpServerApiAdmin extends YpServerApiBase {
    ...
    getCommunityTemplates(domainId) {
        return this.fetchWrapper(this.baseUrlPath + `/communities/${domainId}/getTemplates`);
    }
    getGroupTemplates(domainId) {
        return this.fetchWrapper(this.baseUrlPath + `/groups/${domainId}/getTemplates`);
    }
    createCategory(groupId, body) {
        return this.fetchWrapper(this.baseUrlPath + `/categories/${groupId}`, {
            method: "POST",
            body: JSON.stringify(body),
        }, false);
    }
    updateCategory(categoryId, body) {
        return this.fetchWrapper(this.baseUrlPath + `/categories/${categoryId}`, {
            method: "PUT",
            body: JSON.stringify(body),
        }, false);
    }
    ...
    getCategoryPostsCount(categoryId) {
        return this.fetchWrapper(this.baseUrlPath + `/categories/${categoryId}/getPostsCount`);
    }
