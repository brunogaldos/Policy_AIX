...
export declare class YpServerApiAdmin extends YpServerApiBase {
    ...
    getCommunityTemplates(domainId: number): Promise<any>;
    getGroupTemplates(domainId: number): Promise<any>;
    createCategory(groupId: number, body: Record<string, unknown>): Promise<any>;
    updateCategory(categoryId: number, body: Record<string, unknown>): Promise<any>;
    deleteCategory(categoryId: number): Promise<any>;
    getCategory(categoryId: number): Promise<any>;
    getCategoryPostsCount(categoryId: number): Promise<any>;
