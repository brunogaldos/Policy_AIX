...
export declare class YpAdminConfigGroup extends YpAdminConfigBase {
    ...
    registrationQuestionsJsonError: boolean;
    ...
    _refreshCategories(): Promise<void>;
    _categoryUpdated(): void;
    _categoryDeleted(): void;
    _openCategoryEdit(category?: YpCategoryData): void;
    _newCategory(): void;
    ...
    _categoryImageSrc(category: any): any;
    ...
    _openTemplatesDialog(): Promise<void>;
    _cloneTemplate(template: YpGroupData): Promise<void>;
    renderTemplatesDialog(): import("lit-html").TemplateResult<1>;
    _validateJson(value: string | undefined | null, errorProp: keyof YpAdminConfigGroup): void;
    _structuredQuestionsChanged(event: CustomEvent): void;
    _registrationQuestionsChanged(event: CustomEvent): void;
}
