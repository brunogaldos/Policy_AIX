...
let YpAdminConfigGroup = YpAdminConfigGroup_1 = class YpAdminConfigGroup extends YpAdminConfigBase {
    constructor() {
        ...
        this.registrationQuestionsJsonError = false;
    ...
    async _openClone() {
        ...
        try {
            const newGroup = (await window.serverApi.apiAction(`/api/groups/${this.collection.id}/clone`, "POST", {}));
    ...
    async _refreshCategories() {
        const updatedGroup = (await window.serverApi.getGroup(this.group.id));
    ...
    _openCategoryEdit(category) {
        window.appDialogs.getDialogAsync("categoryEdit", (dialog) => {
            dialog.setup(this.group, category ? false : true, this._categoryUpdated.bind(this), this._categoryDeleted.bind(this), category);
            dialog.open();
        });
    }
    _newCategory() {
    ...
    _categorySelected(event) {
        const categoryId = parseInt(event.detail.value);
    ...
    async _openTemplatesDialog() {
        const domainId = this.parentCollection.domain_id;
        if (!domainId) {
    ...
    async _cloneTemplate(template) {
        ...
        try {
            ...
            `/api/groups/${template.id}/clone`, "POST", {}));
            ...
            window.appGlobals.activity("error", "cloneGroupFromTemplate", err.message);
    ...
    _structuredQuestionsChanged(event) {
        const value = event.target.value;
        if (this.group.configuration) {
    ...
    _registrationQuestionsChanged(event) {
        const value = event.target.value;
        if (this.group.configuration) {
...
], YpAdminConfigGroup.prototype, "cloning", void 0);
__decorate([
    property({ type: Array })
], YpAdminConfigGroup.prototype, "templates", void 0);
__decorate([
    property({ type: Number })
], YpAdminConfigGroup.prototype, "cloningTemplateId", void 0);
__decorate([
    property({ type: String })
], YpAdminConfigGroup.prototype, "apiEndpoint", void 0);
