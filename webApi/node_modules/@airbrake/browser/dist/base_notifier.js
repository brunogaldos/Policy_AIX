...
var remote_settings_1 = require("./remote_settings");
var BaseNotifier = /** @class */ (function () {
    function BaseNotifier(opt) {
        ...
        this._requester = (0, http_req_1.makeRequester)(this._opt);
        this.addFilter(ignore_noise_1.ignoreNoiseFilter);
        this.addFilter((0, debounce_1.makeDebounceFilter)());
        ...
        if (this._opt.remoteConfig) {
            var pollerId_1 = new remote_settings_1.RemoteSettings(this._opt).poll();
    ...
    BaseNotifier.prototype.handleFalseyError = function (err) {
    ...
    BaseNotifier.prototype.newNotice = function (err) {
        return {
            errors: [],
    ...
    BaseNotifier.prototype._sendNotice = function (notice) {
        var body = (0, jsonify_notice_1.jsonifyNotice)(notice, {
