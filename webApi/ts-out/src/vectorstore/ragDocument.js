...
export class PsRagDocumentVectorStore extends PolicySynthAgentBase {
    constructor() {
        super(...arguments);
        this.roughFastWordTokenRatio = 1.25;
        this.maxChunkTokenLength = 500;
...
PsRagDocumentVectorStore.allFieldsToExtract = "title url lastModified size \
...
PsRagDocumentVectorStore.urlField = "url";
PsRagDocumentVectorStore.weaviateKey = PsRagDocumentVectorStore.getWeaviateKey();
PsRagDocumentVectorStore.client = weaviate.client({
