...
PsRagChunkVectorStore.allFieldsToExtract = "title chunkIndex chapterIndex mainExternalUrlFound  \
...
PsRagChunkVectorStore.weaviateKey = PsRagChunkVectorStore.getWeaviateKey();
PsRagChunkVectorStore.client = weaviate.client({
